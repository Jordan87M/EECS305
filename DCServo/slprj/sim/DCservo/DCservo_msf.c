...
#define S_FUNCTION_NAME DCservo_msf
#endif
...
MdlRefChildMdlRec childModels [ 1 ] = { "DCservo" , "DCservo" , 0 } ; const
...
axyxzivhdbq * dw = ( axyxzivhdbq * ) ssGetDWork ( S , 0 ) ; nukvwudi4i *
localX = ( nukvwudi4i * ) ssGetContStates ( S ) ; oq0u0vzqg1 ( & ( dw -> rtdw
) , localX ) ; } static void mdlReset ( SimStruct * S ) { axyxzivhdbq * dw =
( axyxzivhdbq * ) ssGetDWork ( S , 0 ) ; nukvwudi4i * localX = ( nukvwudi4i *
) ssGetContStates ( S ) ; pjw4f2tpxz ( & ( dw -> rtdw ) , localX ) ; } static
...
slmrSetModelRefAutoSolverStatusFlags ( S , 5 ) ; ssSetRTWGeneratedSFcn ( S ,
2 ) ; ssSetNumContStates ( S , 6 ) ; ssSetNumDiscStates ( S , 0 ) ;
...
mr_DCservo_RegisterSimStateChecksum ( S ) ; { static ssRTWStorageType
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstances\"><arguments><arg type=\"encoded\">RABDAHMAZQByAHYAbwAvAFMAYwBvAHAAZQAAAA==</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments></diag>\n</diag_root>"
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_DCservo_MdlInfoRegFcn (
S , "DCservo" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( axyxzivhdbq ) ) )
...
#define MDL_START
static void mdlStart ( SimStruct * S ) { axyxzivhdbq * dw = ( axyxzivhdbq * )
ssGetDWork ( S , 0 ) ; nukvwudi4i * localX = ( nukvwudi4i * ) ssGetContStates
( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ;
ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } ltgy3lilz0 ( S ,
ssGetSampleTimeTaskID ( S , 0 ) , ssGetSampleTimeTaskID ( S , 1 ) , 0 , & (
dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , sysRanPtr ,
sysTid , ( NULL ) , ( NULL ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & (
dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL
) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } } static void
mdlOutputs ( SimStruct * S , int_T tid ) { axyxzivhdbq * dw = ( axyxzivhdbq *
) ssGetDWork ( S , 0 ) ; const real_T * i_i_cuy1wems3o = ( real_T * )
ssGetInputPortSignal ( S , 0 ) ; real_T * o_B_1_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; nukvwudi4i * localX = ( nukvwudi4i * )
ssGetContStates ( S ) ; if ( tid == PARAMETER_TUNING_TID ) { DCservoTID2 ( )
; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if (
ssIsSampleHit ( S , 0 , tid ) || ssIsMinorTimeStep ( S ) ) { DCservo ( & ( dw
-> rtm ) , i_i_cuy1wems3o , o_B_1_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ,
localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { axyxzivhdbq * dw = (
axyxzivhdbq * ) ssGetDWork ( S , 0 ) ; if ( ssIsSampleHit ( S , 0 , tid ) ) {
io42xjwmdi ( & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; }
return ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { axyxzivhdbq * dw = (
axyxzivhdbq * ) ssGetDWork ( S , 0 ) ; const real_T * i_i_cuy1wems3o = (
real_T * ) ssGetInputPortSignal ( S , 0 ) ; l0b2hn4zu4 * localZCSV = (
l0b2hn4zu4 * ) ssGetNonsampledZCs ( S ) ; d02nrneqww ( i_i_cuy1wems3o ,
localZCSV ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { axyxzivhdbq * dw = (
axyxzivhdbq * ) ssGetDWork ( S , 0 ) ; nukvwudi4i * localX = ( nukvwudi4i * )
ssGetContStates ( S ) ; gzx2cfvdiw * localXdot = ( gzx2cfvdiw * ) ssGetdX ( S
) ; nw0hz2etnl ( & ( dw -> rtb ) , localX , localXdot ) ; } static void
...
dwFieldNames ) ; { const nukvwudi4i * localX = ( const nukvwudi4i * )
ssGetContStates ( S ) ; const size_t numBytes = sizeof ( nukvwudi4i ) ;
...
storedX ) ; } { mxArray * mdlrefDW = mr_DCservo_GetDWork ( ssGetDWork ( S , 0
) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_DCservo_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 , 2
...
nukvwudi4i * localX = ( nukvwudi4i * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( nukvwudi4i ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_DCservo_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 ,
