...
MAKECMD         = /usr/local/MATLAB/R2016a/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = DCservoclean
MODULES                 = DCservoclean.c DCservoclean_capi.c 
MAKEFILE                = DCservoclean.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2016a
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2016a
MASTER_ANCHOR_DIR       = 
START_DIR               = /home/jordan/Documents/GitRepositories/EECS305/DCServo/Publish/Lab4/Linux
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 2
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/sim/DCservoclean \
	-I$(START_DIR) \
...
MODELREF_LIB_DEF += -lmwsl_iofile
MODELREF_LIB_DEF += -lmwsigstream
MODELREF_LIB_DEF += -lmwsl_log_load_blocks
...
$(PRODUCT) : $(PREBUILT_OBJS) $(OBJS) $(SHARED_LIB) $(LIBS) $(SRC_DEP) $(MODELLIB) $(MODELREF_LINK_LIBS)
	$(BIN_SETTING) $(LINK_OBJS) $(PREBUILT_OBJS) $(MODELLIB) $(MODELREF_LINK_LIBS_GROUP) $(SHARED_LIB) $(LIBFIXPT) $(LIBS)  $(SYSLIBS)
...
$(PRODUCT) : $(OBJS) $(SHARED_LIB) $(LIBS) $(SRC_DEP) $(MODELREF_LINK_LIBS)
	@echo "### Created $(BUILD_PRODUCT_TYPE): $@"
      ...
      ifeq ($(SFCN),0)
$(PRODUCT) : $(OBJS) $(SHARED_LIB) $(LIBS) $(SRC_DEP) $(MODELREF_LINK_LIBS)
	$(BIN_SETTING) $(LINK_OBJS) $(MODELREF_LINK_LIBS_GROUP) $(SHARED_LIB) $(LIBFIXPT) $(LIBS)  $(SYSLIBS)
	@echo "### Created $(BUILD_PRODUCT_TYPE): $@"
      else
$(PRODUCT) : $(OBJS) $(SHARED_LIB) $(LIBS) $(SRC_DEP) $(MODELREF_LINK_LIBS)
	$(BIN_SETTING) $(LINK_OBJS) $(SHARED_LIB) $(LIBFIXPT) $(LIBS)  $(SYSLIBS)
	@echo "### Created $(BUILD_PRODUCT_TYPE): $@"
      endif
    endif
  endif
 ...
 ifeq ($(MODELREF_TARGET_TYPE),SIM)
  ...
  $(PRODUCT) : $(OBJS) $(SHARED_LIB) $(LIBS) $(SRC_DEP)
	...
	$(BIN_SETTING) $(LIBFIXPT) $(LIBS) $(LIBMWIPP) $(MODELREF_LIB_DEF)
	@echo "### Created $(BUILD_PRODUCT_TYPE): $@"
  ifeq ($(ISPROTECTINGMODEL),PROTECTING)
